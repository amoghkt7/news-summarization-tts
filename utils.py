...
def process_news_articles(company_name, max_articles=5):
    """
    Fetches, summarizes, analyzes sentiment, and converts to speech for news articles.
    Now saves files directly in the main directory (no folders).
    ...
    Returns:
        list: A list of processed articles with title, link, summary, sentiment, and TTS file.
    """
    ...
    for idx, article in enumerate(articles, 1):
        ...
        processed_articles.append({
            ...
            "summary": summary,
            "sentiment": sentiment,
            "audio": audio_filename  # No folder path
        })
